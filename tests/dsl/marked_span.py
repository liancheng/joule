...
# The optional leading "|" makes indenting in editors easier.
marked_spans = P.string("|").optional() >> marked_span.at_least(1)
...
def parse_marked_spans(source: str) -> tuple[str, dict[int, Span]]:
    ...
    pending_marks = ", ".join([str(k) for k in open_marks])
